...
def main() -> None:
    ...
    try:
        ...
        story = Story(
            ...
            style=(
                "网文热血流，唐门暗器与武魂大陆的少年成长腔。短句直给，节奏快，招式名与魂技要朗声报出来（「三环齐出！」）；战斗一板一眼讲章法：魂力差距、魂环年限、配合走位说得清清楚楚，数值感就是仪式感。感情戏青涩纯真，点到即止；同伴之间讲义气、爱打趣。旁白可在紧要处直白点题（这一刻，他忽然明白了什么叫强者）。忌欧化长句，忌华丽堆藻，忌阴郁文艺腔。"),
