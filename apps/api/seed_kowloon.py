...
CHARACTERS = [
    # The protagonist the player embodies by default (character mode). Not a responder.
    {
        ...
        "name": "蔡妍",
        "items": [{"name": "联系线人的纸条",
                   "detail": "贴身藏着的一张小纸条，上面只有一个暗号——她和警队之间唯一的线。"}],
    ...
    },
    {
        ...
        "bio_layers": [
            ...
            {"closeness_min": 45, "text": "他守这座城，像在替谁赎一笔还不清的债。每年有一天他会关店独坐，谁也不见。那天是谁的忌日，没人敢问。"},
        ],
    ...
    },
    {
        ...
        "bio_layers": [
            ...
            {"closeness_min": 45, "text": "他心里锁着一段不愿提的过去、和一笔对龙卷风还不完的旧账。玩笑是他的墙，砌得越高，墙后的东西越重。"},
        ],
    ...
    },
    {
        ...
        "bio_layers": [
            ...
            {"closeness_min": 45, "text": "他最怕的不是打架，是被当成只会冲动的莽夫。他一直在憋一股劲，想证明关键时刻自己顶得上。"},
        ],
    ...
    },
    {
        ...
        "bio_layers": [
            ...
            {"closeness_min": 45, "text": "乱世里他最怕的是被人撇下。小算盘打得再响，真到节骨眼上，兄弟情还是压得过那点便宜。"},
        ],
...
def main() -> None:
    ...
    try:
        ...
        story = Story(
            ...
            style=("香港市井味的普通话。叙事与台词一律用标准中文书写——读者不懂粤语。"
                   "可保留一看就懂的港式称呼与节奏（阿Sir、老板、后生仔），"
                   "但粤语字词与语法一概不用（唔、嘅、咁、系、喺、佢、乜、俾、睇、冇、"
                   "靓仔、靓女、扑街、点解、边个等全部禁止）。"
                   "忌文艺腔堆砌：短句、市井、烟火气，对白多过旁白。"),
