...
FUSHENG_ART = (
    "九十年代日式美少女游戏赛璐璐画风：均匀的深褐色细线稿，赛璐璐两段阴影加一层柔和高光，"
    "平涂不厚涂；发丝分组成束、带菱形高光，眼睛偏大、瞳内两点高光；七头身，低饱和暖调配色，"
    "画面干净通透；舞台是八十年代的九龙城寨：霓虹灯牌与手写招牌层层叠叠，头顶电线结成蛛网，"
    "湿漉漉的窄巷映着暖黄灯光，天台的天线森林与晾衣绳，大牌档的蒸汽"
)
...
SANDBOXES = [
    ...
    },
    {
        ...
        "麻雀馆看场的细辉，都是抬头不见低头见的街坊；话事人龙卷风在龙记理发店里磨他的剃刀。"
