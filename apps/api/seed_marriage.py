...
CHARACTERS = [
    {
        "id": "mw_lin", "name": "林晚", "role": "插画师，这纸婚约的另一半",
    ...
    {
        "id": "mw_gu", "name": "顾之衍", "role": "顾氏继承人，你的「合约丈夫」",
        "is_lead": True,
        ...
        "schedule": [
            {"from_act": 1, "location_id": "mw_dining", "slots": ["晨"]},
            {"from_act": 1, "location_id": "mw_study", "slots": ["夜"]},
        ],  # 午间无排班 = 在公司，不知去向——打电话、发消息的时段
        "ties": [{"char_id": "mw_yao", "stance": 2, "label": "捧在手心的妹妹"},
                 {"char_id": "mw_chen", "stance": 2, "label": "看着他长大的人"},
                 {"char_id": "mw_su", "stance": 1, "label": "托付了要紧事的老同学"}],
    },
    {
        "id": "mw_chen", "name": "陈妈", "role": "顾宅老管家",
        ...
        "home_location_id": "mw_hall",
        "ties": [{"char_id": "mw_gu", "stance": 2, "label": "半个娘"}],
    },
    {
        "id": "mw_yao", "name": "顾之瑶", "role": "顾之衍的妹妹，大学生，术后休养中",
        "appears_from_act": 2,
        ...
        "home_location_id": "mw_garden",
        "ties": [{"char_id": "mw_gu", "stance": 2, "label": "最崇拜的哥哥"},
                 {"char_id": "mw_su", "stance": 2, "label": "救过我的苏医生"}],
    },
    {
        "id": "mw_su", "name": "苏晚晴", "role": "心外科医生，传闻里的「白月光」",
        "appears_from_act": 3,
        ...
        "home_location_id": "mw_cafe",
        "ties": [{"char_id": "mw_gu", "stance": 1, "label": "老同学，受人之托"},
                 {"char_id": "mw_yao", "stance": 2, "label": "我的病人"}],
    },
]

LOCATIONS = [
    {"id": "mw_hall", "name": "顾宅客厅", "detail": "挑高的客厅，水晶灯常年只开一半。"
     "长沙发中间隔着一只从不挪动的靠枕，像一条无形的分界线。",
     "exits": ["餐厅", "玫瑰园", "书房", "老宅阁楼", "半山咖啡馆"]},
    {"id": "mw_dining", "name": "餐厅", "detail": "长桌可坐十二人，但每天只摆两副碗筷，"
     "隔着最远的对角。你的那侧永远有一碟不加香菜的小菜。",
     "exits": ["顾宅客厅"]},
    {"id": "mw_study", "name": "书房", "detail": "整面墙的书，办公桌一尘不染。"
     "只有书桌最下层的抽屉上着锁，钥匙孔擦得发亮——常开，却不许人碰。",
     "exits": ["顾宅客厅"],
     "props": [{"name": "上锁的抽屉", "detail": "锁着。钥匙孔周围的漆磨掉了一圈，主人常开它。"}]},
    {"id": "mw_garden", "name": "玫瑰园", "detail": "后院的玫瑰开得没什么章法，"
     "一看就不是园丁的手笔。廊下有把藤椅，扶手磨得发白。",
     "exits": ["顾宅客厅"]},
    {"id": "mw_attic", "name": "老宅阁楼", "detail": "积灰的旧家具蒙着白布，"
     "只有靠窗那只樟木箱干干净净——有人常来擦它。",
     "exits": ["顾宅客厅"],
     "unlock": {"required_fragment_ids": ["mw_chenma1"]},
     "props": [{"name": "樟木箱", "detail": "没有上锁，箱盖内侧贴着一张泛黄的画展门票。",
                "fragment_id": "mw_origin3"}]},
    {"id": "mw_cafe", "name": "半山咖啡馆", "detail": "医院对面的咖啡馆，苏晚晴的固定座位在窗边。"
     "桌上常年放着两份糖——她不吃糖。",
     "exits": ["顾宅客厅"],
     "unlock": {"act_min": 3}},
]
...
ACTS = [
    ...
    {"id": "a3", "index": 3, "title": "白月光传闻", "time": {"day": 3},
     ...
     "advance": {"required_fragment_ids": ["mw_su2"]},
     "events": [
    ...
    {"id": "a4", "index": 4, "title": "阁楼旧箱", "time": {"day": 4},
     ...
     "advance": {"required_fragment_ids": ["mw_origin3"]},
     "events": [
     ...
     "choice": {
         ...
         "options": [
             {"id": "stay", "label": "把手放进他掌心", "flag": "chose_stay",
              "character_id": "mw_gu", "closeness_delta": 4, "romance_delta": 6},
...
SECRETS = [
    ("婚约的真正起因", "mw_gu", "medium", ["mw_gu"], [
        ...
        ("mw_origin3", 3,
         ...
         {"location_id": "mw_attic", "act_min": 4},
         None),
    ]),
    ("苏晚晴的来意", "mw_su", "medium", ["mw_su", "mw_gu"], [
        ("mw_su1", 1,
    ...
    ("之瑶的小算盘", "mw_yao", "light", ["mw_yao", "mw_su"], [
        ("mw_yao1", 1,
...
ENDINGS = [
    {"id": "end_true", "kind": "true", "title": "十年之后，倾盖如故",
     ...
     "condition": {"affinity_min": 24, "act_min": 0,
                   "required_fragment_ids": ["mw_origin3"],
